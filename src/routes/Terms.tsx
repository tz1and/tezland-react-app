            ...
            <div className="container px-4 py-4">
                <div className="row justify-content-center">
                    <div className="col-md-8">
                        ...
                        <p>
                            We (tz1and) assume no liability for damages incurred by use or by the users of this platform. Including, but not limited to: copy-minting (or other types of copyright infringement), potential exploits, money laundering or scams.
                        </p>
                        <p>
